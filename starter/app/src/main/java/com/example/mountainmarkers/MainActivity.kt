...
import com.google.android.gms.maps.MapsInitializer // <--- ADDED IMPORT
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //  Initialize the Google Maps SDK before using any map components (like CameraUpdateFactory)
